...
void MAP_Init()
{
	...
	CreatePathBetweenNode(2, 1, 0, 10, 10,Speed_High);  //100
	...
	CreatePathBetweenNode(5, 4, 0, 2, 90,Speed_High)->specifiedTrackFunction = getToLine_Mixed;

	CreatePathBetweenNode(4, 6, -35, 2, 220, Speed_Low);
	CreatePathBetweenNode(6, 2, 35, 2, 205, Speed_Mid);
	...
	CreatePathBetweenNode(52, 26, -35, 2, 95, Speed_VeryHigh);//95
	CreatePathBetweenNode(24, 52, 35, 2, 95, Speed_VeryHigh);//95
	...
	CreatePathBetweenNode(26, 27, 0, 2, 50, Speed_VeryHigh);
	CreatePathBetweenNode(27, 28, 0, 2, 250, Speed_VeryHigh);
	...
	//圆
	CreatePathBetweenNode(15, 29, 90, 2, 60, Speed_Mid);
	CreatePathBetweenNode(14, 29, 5, 2, 80, Speed_Mid);   //
	CreatePathBetweenNode(29, 16, -5, 2, 10, Speed_Mid);   //
	CreatePathBetweenNode(14, 23, -30, 200, 250, Speed_Low-10)->SingeDirectionOnly = true;   //
	...
	CreatePathBetweenNode(42, 43, 0, 2, 0, Speed_High);
	...
	CreatePathBetweenNode(44, 37, 90, 2, 60, Speed_High);
	CreatePathBetweenNode(44, 45, 0, 2, 50, Speed_Mid);
	...
	CreatePathBetweenNode(50, 51, 0, 2, 250, Speed_Low);
