...
int Test_Param_Turn_Angle = 20;
int Test_Param_Turn_Speed = 40;
int TurnByPulsePremeterL = 460;
int TurnByPulsePremeterR = 395;
...
void turnAngleByPulse(int aA,int turnSpeed)
{
	setPixelColor(Color_purple);
	if (aA == 0)
		return;
...
{
	turnToOnLine(Test_Param_Turn_Angle, 0);
}
void Test_turnAngleByPulse()
{
	turnAngleByPulse(Test_Param_Turn_Angle);
}
void Test_turnAngleByPulseSpeed()
{
	turnAngleByPulse(Test_Param_Turn_Angle, Test_Param_Turn_Speed);
}
